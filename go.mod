...
// Pin these; we will take those updates separately and carefully
replace github.com/aws/aws-sdk-go => github.com/aws/aws-sdk-go v1.37.8

replace github.com/prometheus/client_golang => github.com/prometheus/client_golang v1.9.0

replace google.golang.org/api => google.golang.org/api v0.39.0
